defmodule FlagQuestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FlagQuestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FlagQuestWeb.Gettext, "errors", msg, opts)
    end
  end
